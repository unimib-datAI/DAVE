  ...
  [
    {
      Icon: <FiNavigation />,
      action: 'select',
      label: 'leftSidebar.actionsTooltips.select',
    },
    {
      Icon: <FiPlus />,
      action: 'add',
  ...
  [
    {
      Icon: <FiServer />,
      action: 'clusters',
      label: 'leftSidebar.actionsTooltips.clusters',
    },
  ],
  [
    {
      Icon: <FiList />,
      action: 'data',
      label: 'leftSidebar.actionsTooltips.data',
    },
  ],
  [
    {
      Icon: <FiSettings />,
      action: 'settings',
      label: 'leftSidebar.actionsTooltips.settings',
    },
  ],
];
