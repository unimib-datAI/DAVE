        ...
        {open && (
          ...
          >
            ...
            <CommandRow>
              ...
              <span>Select candidate as match</span>
            </CommandRow>
            <CommandRow>
              <ShortcutButton shortcut={['Ctrl', 'a']} />→
              <span style={{ lineHeight: 1.3 }}>
                Add precompiled entity to list of candidates and select it as
                match
              </span>
            </CommandRow>
            <CommandRow>
              <ShortcutButton shortcut={['Ctrl', 'Enter']} />→
              <span>Confirm current selection</span>
            </CommandRow>
            <CommandRow>
              <ShortcutButton shortcut={['Ctrl', 'Space']} />→
              <span>Assign NIL to annotation</span>
            </CommandRow>
            <CommandRow>
              <ShortcutButton shortcut={['\\']} />→<span>Open search</span>
            </CommandRow>
          </PopoverContainer>
        )}
      </AnimatePresence>
