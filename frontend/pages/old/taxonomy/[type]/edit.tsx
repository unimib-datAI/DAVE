...
import NodeManagement, {
  NodeManagementFormState,
} from '@/modules/taxonomy/NodeManagement';
import {
  useSelector,
  useTaxonomyDispatch,
} from '@/modules/taxonomy/TaxonomyProvider/selectors';
...
const EditTypePage: NextPageWithLayout<LayoutContentProps> = ({ type }) => {
  ...
  const handleSearchExamples = () => {
    router.push(`/taxonomy/${type}/zero-shot-candidates`, undefined, {
      shallow: true,
    });
  };
            ...
            <>
              ...
              {taxonomyNode.parent && (
                <Button
                  ...
                  auto
                  disabled={
                    !taxonomyNode.terms || taxonomyNode.terms.length === 0
                  }
                  iconRight={<FiSearch />}
...
EditTypePage.getLayout = function getLayout(
  page: ReactElement<LayoutContentProps>
) {
